...
type SwipeableRowProps = {
  children: ReactNode;
  /** Tap navigates here. Omit for rows that only reveal an action. */
  href?: string;
  open: boolean;
  ...
  /** Overrides the visible label for assistive tech when several rows exist. */
  actionAriaLabel?: string;
};

/** Shared swipe-to-reveal used by expense rows and recent payments. */
